...
/*    functionManager.registerFunction(DefaultPermissionsManager.FUNCTION_NEW_FORUM);
  ...
  {
    return hasPermission(role, DefaultPermissionsManager.FUNCTION_VIEW_READBY_ANY);
  }
  ...
  {
    return hasPermission(role, DefaultPermissionsManager.FUNCTION_VIEW_READBY_OWN);
  }
