...
<%--      <sakai:button_bar_item action="#{ForumTool.processDfMsgDeleteConfirm}" value="Delete" 
	...
	<%-- this section works, but has no expand/collapse --%>
        <%-- h:outputText value="Read By"/ --%>
        <%-- h:outputText value="#{ForumTool.selectedMessage.message.readby}" / --%>

	<%-- this section works, but it needs some formatting --%>
        <%-- h:outputText value="Read By"/ --%>
        <%-- @include file="/jsp/discussionForum/permissions/readby_include.jsp" --%>
