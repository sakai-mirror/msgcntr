...
<f:verbatim>
	...
	<div class="topic-picker" id="topic-picker" title="Move Thread(s)">
		<div class="selected-threads-to-move">
			<div style="padding-left: .3em; margin-top: .5em">
				...
				<h:outputText styleClass="sourcetitle" escape="false" value="#{ForumTool.selectedTopic.topic.title}"  /> 
 				<h:outputText value="#{msgs.move_thread_info2}"  />
			</div>

                        <div class="threads-to-move" escape="false">
			</div>
             ...
             <div class="topic-filter">
                 ...
                 <div style="padding-left: .3em; margin-top: 1em">
                     ...
                     <div class="topic-source">
                        <div class="topic-filter-header">
                     		<span class="topic-header-h3"><h:outputText value="#{msgs.topics}"  />
				</span>
	...
	<div id="data" style="display:none">
		<h:outputText escape="false" value="#{ForumTool.moveThreadJSON}" />
	</div>
</f:verbatim>
