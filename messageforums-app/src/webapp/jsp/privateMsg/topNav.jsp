 ...
 <h:panelGrid columns="2" summary="layout" width="100%" styleClass="navPanel">	 		
	<h:panelGroup>
		<f:verbatim><div class="breadCrumb specialLink"><h3></f:verbatim>
			...
			<h:outputText value="#{PrivateMessagesTool.selectedTopicIntTitle}" rendered="#{PrivateMessagesTool.searchPvtMsgsEmpty}" />
		
			<h:commandLink action="#{PrivateMessagesTool.processDisplayForum}" value="#{PrivateMessagesTool.selectedTopicIntTitle}" title=" #{msgs.cdfm_message_forums}"
