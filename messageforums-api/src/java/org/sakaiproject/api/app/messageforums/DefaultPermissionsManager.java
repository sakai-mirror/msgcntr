...
public interface DefaultPermissionsManager
{
  ...
  public static final String FUNCTION_VIEW_READBY_ANY="messagecenter.viewReadbyAny";
  public static final String FUNCTION_VIEW_READBY_OWN="messagecenter.viewReadbyOwn";  
  ...
  public boolean isViewReadbyAny(String role);

  public boolean isViewReadbyOwn(String role);
